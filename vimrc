...
if dein#load_state(s:dein_dir)
    ...
    let s:python_toml = g:rc_dir . '/python_dev.toml'
    call dein#begin(s:dein_dir, [$MYVIMRC, s:toml, s:lazy_toml, s:python_toml])
    " TOML を読み込み、キャッシュしておく
    call dein#load_toml(s:toml,      {'lazy': 0})
    call dein#load_toml(s:lazy_toml, {'lazy': 1})
    call dein#load_toml(s:python_toml, {'lazy': 1})
    call dein#load_toml(g:rc_dir . '/cc.toml', {'lazy': 1})
   " 設定終了
    call dein#end()
